        ...
        <div class="container">
            ...
            <div class="button">
                <div class="search-box">
                    <form action="" method="get">
                        <input type="text" name="search" placeholder="Search by Date, Teacher Name, or Course Name">
            ...
            <table>
                ...
                if (isset($_GET['search'])) { 
                    $search = $_GET['search']; 
                    $sql = "SELECT * FROM teacher_feedback WHERE teacher_name LIKE '%$search%' OR Course_name LIKE '%$search%' OR feedback_date LIKE '%$search%'"; 
                } 
                else { 
