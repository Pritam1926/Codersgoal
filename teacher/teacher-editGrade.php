    ...
    <div class="admission-container">
        ...
        <form action="teacher-editGrade-submit.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" id="total_marks" name="total_marks" value="<?php echo $row['total_marks']; ?>"
                    required oninput="calculatePercentageAndGrade()">
            </div>
            <div class="form-group">
                <label for="marks_obtained">Marks Obtained:</label>
                <input type="number" id="marks_obtained" name="marks" value="<?php echo $row['marks']; ?>" required
                    oninput="calculatePercentageAndGrade()">
            </div>
            <div class="form-group">
                <label for="percentage">Percentage:</label>
                <input type="text" id="percentage" name="percentage" value="<?php echo $row['percentage']; ?>" readonly>
            </div>
            <div class="form-group">
