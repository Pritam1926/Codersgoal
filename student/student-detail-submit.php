...
if ($conn->query($sql) === TRUE) {
    ...
    if ($conn->query($sql1) === TRUE) {
        ...
        try {
            ...
            $mail->send();
            echo "<script>alert('Admission successful! A confirmation email has been sent. You will be redirected to the home page.'); window.location.href = '/index.php';</script>";
        } catch (Exception $e) {
