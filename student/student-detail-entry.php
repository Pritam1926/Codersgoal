...
<body>
    <div class="admission-container">
        <a href="/admission.php" class="button">⬅️Back</a>
        ...
        <form action="student-detail-submit.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="marksheet">Previous qualification marksheet:</label>
            ...
            <div class="form-group">
                ...
                <img src="/img/qr.jpg" alt="QR Code for Payment" class="img">
            </div>
            <div class="form-group">
